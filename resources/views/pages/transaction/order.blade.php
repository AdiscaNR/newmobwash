...
<head>
    ...
    <title>Create Order - MobWash</title>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('order.store', $tx->id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="client_name" class="form-control"
                                                        ...
                                                        value="{{ $tx->client->name }}" required readonly>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="client_phone" class="form-control"
                                                        id="phone" placeholder="08xxx"
                                                        value="{{ $tx->client->phone }}" required readonly>
                                                </div>
                                            </div>
                                            <div class="col">
                                                @php
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="crew_name" class="form-control"
                                                        id="name" placeholder="Crew Name"
                                                        value="{{ $crewNames }}" required readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="checkin">Check In</label>
                                                    <input type="time" name="checkin" class="form-control"
                                                        id="checkin" placeholder="Check In" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="checkout">Check Out</label>
                                                    <input type="time" name="checkout" class="form-control"
                                                        id="checkout" placeholder="Check Out" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button type="button" class="btn btn-primary my-2"
                                            onclick="addServiceRow()">Add Service</button>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; MobWash 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
